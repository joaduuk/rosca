...
from app.core.notifications import notify_group_created
...
def create_group(
    ...
    try:
        notify_group_created(
            ...
            contribution_amount=float(new_group.contribution_amount),
            currency=new_group.currency,
        )
    except Exception as e:
        print(f"[NOTIFY] Failed to notify admins of new group: {e}")
