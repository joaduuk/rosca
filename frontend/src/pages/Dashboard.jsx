...
export default function Dashboard() {
  ...
  const handleAddMember = async (userId) => {
    try {
      await API.post(`/groups/${selectedGroup.id}/members/${userId}?is_admin=false`);
      ...
      {showAddMember && (
        <div style={styles.overlay}>
          <div style={styles.modal}>
            ...
            <div style={styles.field}>
              <label style={styles.label}>Search by Email</label>
            ...
            <div style={styles.modalActions}>
              <button onClick={() => { setShowAddMember(false); setSearchEmail(''); setAvailableUsers([]); }} style={styles.cancelBtn}>Close</button>
            </div>
          </div>
        </div>
      )}
