        ...
        <div style={{ display: 'grid', gridTemplateColumns: mobile ? '1fr' : 'repeat(4, 1fr)', gap: '2rem', marginBottom: '2.5rem' }}>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', margin: 0, padding: 0 }}>
              {[['Home', '/'], ['Login', '/login'], ['Create Account', '/login'],  ['Blog', '/blog']].map(([label, to]) => (
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', margin: 0, padding: 0 }}>
              {[['Terms & Conditions', '#terms'], ['Privacy Policy', '#privacy'], ['Cookie Policy', '#privacy'],['Contact', '/contact']].map(([label, href]) => (
                <li key={label} style={{ marginBottom: '0.5rem' }}>
